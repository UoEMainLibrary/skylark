...
/**
 * Replace the short placeholder RESP accessibility statement in cms_pages
 * with the full statement ported from legacy static/eerc/accessibility.php.
 */
return new class extends Migration
{
    private const COLLECTION = 'eerc';

    private const SLUG = 'accessibility';

    public function up(): void
    {
        $body = trim(view('eerc-v2.partials.accessibility_statement_body')->render());
