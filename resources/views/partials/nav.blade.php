    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse">
            <ul class="nav navbar-nav" id="navbar-middle">
                ...
                <li><a href="{{ route('about') }}" target="_blank" title="About Edinburgh University Collections">About <span class="sr-only">(opens in a new tab)</span></a></li>
                <li><a href="{{ route('feedback') }}" target="_blank" title="Provide feedback">Feedback <span class="sr-only">(opens in a new tab)</span></a></li>
            </ul>
...
<div id="content" class="tab-heading">
    <div class="container">
        <ul class="cldmenu" >
            <li class="current" ><a href="{{ url('/search/*/Type:%22archives+%7C%7C%7C+Archives%22/Header:%22archives%22') }}?sort_by=cld.weighting_sort+desc,dc.title_sort+asc" data-hover="ARCHIVES" title="Archive and Manuscript Collections">Archives</a></li>
            <li><a href="{{ url('/search/*/Type:%22rare+books+%7C%7C%7C+Rare+Books%22/Header:%22rarebooks%22') }}?sort_by=cld.weighting_sort+desc,dc.title_sort+asc" data-hover="RARE BOOKS" title="Rare Book Collections">Rare Books</a></li>
            <li><a href="{{ url('/search/*/Type:%22mimed+%7C%7C%7C+MIMEd%22/Header:%22mimed%22') }}?sort_by=cld.weighting_sort+desc,dc.title_sort+asc" data-hover="MUSICAL INSTRUMENTS" title="Musical Instrument Collections">Musical Instruments</a></li>
            <li><a href="{{ url('/search/*/Type:%22art+%7C%7C%7C+Art%22/Header:%22art%22') }}?sort_by=cld.weighting_sort+desc,dc.title_sort+asc" data-hover="ART" title="Art Collections">Art</a></li>
            <li><a href="{{ url('/search/*/Type:%22museums+%7C%7C%7C+Museums%22/Header:%22museums%22') }}?sort_by=cld.weighting_sort+desc,dc.title_sort+asc" data-hover="MUSEUMS" title="Museums">Museums</a></li>
        </ul>
    </div>
</div>
