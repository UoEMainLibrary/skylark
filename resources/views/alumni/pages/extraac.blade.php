...
@section('title', 'Extra Academical Students - University of Edinburgh Historical Alumni')

@section('content')
<div class="content">
    <div class="content byEditor about">
        <h1>Extra Academical students, 1887-1922</h1>
        <h2><a href='alumni/search/*:*/Collection:"extra+academical+students%2C+1887-1922%7C%7C%7CExtra+Academical+students%2C+1887-1922"'><i class="fa fa-search fa-lg">&nbsp;</i>View all records</a></h2>
