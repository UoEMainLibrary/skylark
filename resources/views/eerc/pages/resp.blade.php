...
@section('title', 'Regional Ethnology Scotland Archive Project - EERC')
...
<div class="col-md-9 col-sm-9 col-xs-12" style="margin-top: 20px;">
    <div class="content byEditor">
        ...
        <img src="{{ asset('collections/eerc/images/thumbs_processed/thumbnail_DG8-1-4-4.JPG') }}" alt="Interviews of Isobel Sutherland aged 57" width="300" class="img-responsive pull-right padded_images" />
        <img src="{{ asset('collections/eerc/images/thumbs_processed/thumbnail_DG11-1-4-2.JPG') }}" alt="Interviews of Nancy McLucas, Christine Wilson and Eric Wilson" width="300" class="img-responsive pull-right padded_images" style="margin-top: 1em; clear:both;" />
        <img src="{{ asset('collections/eerc/images/eerc_logo.png') }}" alt="European Etnological Research Centre" width="250" class="img-responsive pull-right padded_images" style="margin-top: 1em; clear:both;" />
        <img src="{{ asset('collections/eerc/images/CRC_logo.gif') }}" alt="Centre for Research Collections" width="150" class="img-responsive pull-right padded_images" style="margin-top: 1em; clear:both;" />

        <p>The EERC has been working with the <a href="https://www.ed.ac.uk/information-services/library-museum-gallery/cultural-heritage-collections/crc" target="_blank">Centre for Research Collections at the University of Edinburgh <span class="sr-only">(opens in a new tab)</span></a> since 2018 cataloguing and digitally preserving a collection centred around hundreds of audio recordings and developing and building an on-line platform to aid the discovery of the RESP Archive and ensure its long term preservation and stability.</p>
        ...
        <img src="{{ asset('collections/eerc/images/resp-handwriting.png') }}" alt="Part of a handwritten transcription from an interview" class="img-responsive center-block padded_images" style="margin-top: 1em; clear:both;" />
        ...
        <img src="{{ asset('collections/eerc/images/partnerships-resp.jpg') }}" alt="Partnerships" width="300" class="img-responsive pull-right padded_images" style="margin-top: 1em; clear:both;" />
        ...
        <ul class="content">
            <li><a href="http://www.stranraerhistory.org.uk/" target="_blank">Stranraer and District Local History Trust <span class="sr-only">(opens in a new tab)</span></a></li>
            <li><a href="https://www.peterpanmoatbrae.org/" target="_blank">Peter Pan Moat Brae Trust <span class="sr-only">(opens in a new tab)</span></a></li>
            <li>Kirkcudbright Harbour Cottage Trust</li>
        </ul>

        <img src="{{ asset('collections/eerc/images/books_resp.jpg') }}" alt="People holding books" class="img-responsive center-block padded_images" style="margin-top: 2em; margin-bottom: 2em; clear:both;" />
    </div>
</div>
