...
<head>
    <meta charset="utf-8">
    <title>@yield('title', 'University of Edinburgh Calendars')</title>

    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <meta name="description" content="">
    <meta name="author" content="">
    <meta name="title" content="University of Edinburgh Calendars">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">

    <base href="{{ \App\Support\CollectionUrl::baseHref() }}">

    <link rel="shortcut icon" href="{{ asset('collections/calendars/images/favicon.ico') }}">
    <link rel="apple-touch-icon" href="{{ asset('collections/calendars/images/apple-touch-icon.png') }}">

    <link rel="stylesheet" href="{{ asset('collections/calendars/css/style.css') }}?v=2">
    ...
    <div id="container">
        <header>
            <div id="collection-title">
                ...
                <a href="{{ url('/calendars') }}" class="logo" title="University of Edinburgh Calendars Home"></a>
                <a href="{{ url('/calendars') }}" class="menulogo" title="University of Edinburgh Calendars Home"></a>
            </div>
            <div id="collection-search">
                <form action="{{ url('/calendars/redirect') }}" method="post">
                    @csrf
                    <fieldset class="search">
                        ...
                        <a href="{{ url('/calendars/advanced') }}" class="advanced">Advanced search</a>
                    </fieldset>
                </form>
            </div>
        </header>
                    ...
                    <div class="footer-disclaimer">
                        <div class="footer-policies">
                            <p>
                                ...
                                &nbsp;&nbsp;<a href="{{ url('/calendars/takedown') }}" title="Takedown Policy Link">Takedown Policy</a>
                                &nbsp;&nbsp;<a href="{{ url('/calendars/licensing') }}" title="Licensing and Copyright Link">Licensing &amp; Copyright</a>
                                &nbsp;&nbsp;<a href="{{ url('/calendars/accessibility') }}" title="Website Accessibility Link" target="_blank">Accessibility<span class="sr-only"> (Opens in a new tab)</span></a>
                            </p>
                        </div>
                    </div>
                </footer>
