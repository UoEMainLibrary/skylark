...
<head>
    <meta charset="utf-8">
    <title>@yield('title', 'School of Physics and Astronomy Image Archive')</title>

    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <meta name="description" content="">
    <meta name="author" content="">
    <meta name="title" content="School of Physics and Astronomy Image Archive">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">

    <base href="{{ \App\Support\CollectionUrl::baseHref() }}">

    <link rel="shortcut icon" href="{{ asset('collections/physics/images/favicon.ico') }}">
    <link rel="apple-touch-icon" href="{{ asset('collections/physics/images/apple-touch-icon.png') }}">

    <!-- CSS: implied media="all" -->
    <link rel="stylesheet" href="{{ asset('collections/physics/css/style.css') }}?v=2">
    ...
    <div id="container">
        <header>
            <div id="collection-title">
                ...
                <a href="{{ url('/physics') }}" class="physicslogo" title="School of Physics &amp; Astronomy Image Archive"></a>
            ...
            <div id="collection-search">
                <form action="{{ url('/physics/redirect') }}" method="post">
                    @csrf
                    <fieldset class="search">
                        ...
                        <a href="{{ url('/physics/advanced') }}" class="advanced">Advanced search</a>
                    </fieldset>
                </form>
            </div>
        </header>
                    ...
                    <div class="footer-disclaimer">
                        <div class="footer-policies">
                            <p>
                                ...
                                &nbsp;&nbsp;<a href="{{ url('/physics/takedown') }}" title="Takedown Policy Link">Takedown Policy</a>
                                &nbsp;&nbsp;<a href="{{ url('/physics/licensing') }}" title="Licensing and Copyright Link">Licensing &amp; Copyright</a>
                                &nbsp;&nbsp;<a href="{{ url('/physics/accessibility') }}" title="Website Accessibility Link" target="_blank">Accessibility<span class="sr-only"> (Opens in a new tab)</span></a>
                            </p>
                        </div>
                    </div>
                </footer>
