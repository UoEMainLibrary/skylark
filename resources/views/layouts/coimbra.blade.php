...
<head>
    ...
    <title>@yield('title', 'Coimbra Virtual Exhibition')</title>
    ...
    <link rel="shortcut icon" href="{{ asset('collections/coimbra/images/favicon.ico') }}">
    <link rel="apple-touch-icon" href="{{ asset('collections/coimbra/images/apple-touch-icon.png') }}">
    ...
    <link rel="stylesheet" href="{{ asset('collections/coimbra/css/style.css')}}">
    <link rel="stylesheet" href="{{ asset('collections/coimbra//css/animate.css')}}">
    ...
    <script src="{{ asset('collections/coimbra/js/google_map.js')}}"></script>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav">
                    <li class="active dropdown"><a href={{ url('/coimbra/') }}>Home</a></li>
                    <li><a href="{{ url('/coimbra/feedback') }}">Feedback</a></li>
                    <li><a href="{{ url('/coimbra/about') }}">About</a></li>
                    <li><a href="{{ url('/coimbra/intro') }}">Intro</a></li>
                </ul>
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="./search">All records</a></li>
                    <li class="search">
                        <form role="search" action="{{ url('/coimbra/redirect') }}" method="post">
                            @csrf
