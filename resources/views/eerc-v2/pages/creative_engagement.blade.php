...
<div class="lg:grid lg:grid-cols-4 lg:gap-8">
    <div class="lg:col-span-3">
        ...
        <div class="mt-6 prose prose-lg max-w-none">
            <div class="not-prose float-right ml-6 mb-4 hidden sm:block">
                <img src="{{ asset('collections/eerc/images/v2/creative/image1.jpeg') }}" alt="RESP creative engagement" class="w-56 rounded-lg shadow-sm">
            </div>
            ...
            <div class="not-prose clear-both my-8 grid grid-cols-2 gap-3 sm:grid-cols-3">
                <img src="{{ asset('collections/eerc/images/v2/creative/image2.jpeg') }}" alt="RESP fieldwork" class="rounded-lg shadow-sm">
                <img src="{{ asset('collections/eerc/images/v2/creative/image5.jpeg') }}" alt="RESP community" class="rounded-lg shadow-sm">
                <img src="{{ asset('collections/eerc/images/v2/creative/image6.jpeg') }}" alt="RESP engagement" class="rounded-lg shadow-sm">
            </div>
            ...
            <div class="not-prose my-8 flex justify-center">
                <img src="{{ asset('collections/eerc/images/v2/creative/image3.png') }}" alt="RESP research" class="max-w-sm rounded-lg shadow-sm">
            </div>
            ...
            <div class="not-prose float-right ml-6 mb-4 hidden sm:block">
                <img src="{{ asset('collections/eerc/images/v2/creative/image7.jpeg') }}" alt="Community engagement" class="w-56 rounded-lg shadow-sm">
            </div>
            ...
            <ul>
                ...
                <li>Using the resources on our <a href="{{ url('/eerc/exhibition') }}">Exhibitions Page</a>, host an event to promote community engagement, perhaps within a care home setting or with a local carers support group.</li>
                <li>Using the resources in our <a href="{{ url('/eerc/kids') }}">Kids Zone</a> when working with children to promote cross-generational work, encourage learning and skills development.</li>
            </ul>
            ...
            <div class="not-prose float-right ml-6 mb-4 hidden sm:block">
                <img src="{{ asset('collections/eerc/images/v2/creative/image4.png') }}" alt="Schools and education" class="w-64 rounded-lg shadow-sm">
            </div>
