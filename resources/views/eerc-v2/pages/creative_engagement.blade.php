        ...
        <div class="mt-6 prose prose-lg max-w-none [&_ul]:marker:text-gray-500">
            ...
            <div class="mb-6 mt-0 space-y-6">
                ...
                <div class="not-prose flex flex-wrap justify-center gap-4 sm:gap-5">
                    <div class="w-40 shrink-0 overflow-hidden sm:w-44 md:w-48">
                        <img src="{{ asset('collections/eerc/images/v2/creative/EL35-3-4-2-crop.jpg') }}" alt="Historical photograph of a woman carrying a basket on her back" class="h-40 w-full rounded-lg object-contain shadow-sm sm:h-44 md:h-48">
                    </div>
                    <div class="flex w-40 shrink-0 items-center justify-center overflow-hidden sm:w-44 md:w-48">
                        <img src="{{ asset('collections/eerc/images/v2/creative/image2.jpeg') }}" alt="Historical photograph of a group of working men" class="aspect-[4/3] w-full rounded-lg object-cover shadow-sm">
                    </div>
                    <div class="flex w-40 shrink-0 items-center justify-center overflow-hidden sm:w-44 md:w-48">
                        <img src="{{ asset('collections/eerc/images/v2/creative/EL6-3-4-7.jpg') }}" alt="Photograph from the RESP archive collection" class="aspect-[4/3] w-full rounded-lg object-cover shadow-sm">
                    </div>
                    <div class="flex w-40 shrink-0 items-center justify-center overflow-hidden sm:w-44 md:w-48">
                        <img src="{{ asset('collections/eerc/images/v2/creative/EL39-7-4-4.jpg') }}" alt="Photograph from the RESP archive collection" class="aspect-[4/3] w-full rounded-lg object-cover shadow-sm">
                    </div>
                </div>
            </div>
