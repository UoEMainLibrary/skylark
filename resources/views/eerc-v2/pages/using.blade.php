...
<div class="lg:grid lg:grid-cols-4 lg:gap-8">
    <div class="lg:col-span-3">
        ...
        <div class="mt-6 space-y-6">
            ...
            <h2 class="text-2xl font-bold tracking-tight text-gray-900">Browse the Collections</h2>
            ...
            <div class="flex flex-col gap-6 sm:flex-row sm:items-start">
                ...
                <div class="mx-auto hidden w-72 max-w-full shrink-0 sm:mx-0 sm:ml-6 sm:block">
                    <img src="{{ asset('collections/eerc/images/thumbs_processed/thumbnail_DG3-3-4-14.jpeg') }}" alt="Interviews of John Armstrong aged 72" class="h-auto w-72 max-w-full rounded-lg shadow-sm">
                </div>
            </div>
            ...
            <div class="prose prose-lg max-w-none">
                ...
                <p>Please note that there may be instances of poor sound quality within recordings due to unavoidable issues with individual recordings.</p>
