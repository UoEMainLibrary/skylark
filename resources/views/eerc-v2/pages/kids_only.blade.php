...
<div class="mx-auto max-w-4xl">
    ...
    <div class="mt-8 space-y-4">
        @php
            $activities = [
                ['title' => 'Farming', 'color' => 'red', 'bgColor' => 'bg-red-50 border-red-200', 'textColor' => 'text-red-700', 'description' => 'Find out about Irene Brown and her memories of working on a farm.', 'pdf' => 'Farming.pdf', 'audio' => \App\Helpers\BitstreamHelper::rewriteBitstreamUrl('https://digitalpreservation.is.ed.ac.uk/bitstream/handle/20.500.12734/57057/farming_compilation_DG5-1-1-1_and_DG38-9-1-1.mp3')],
                ['title' => 'School Dinners', 'color' => 'blue', 'bgColor' => 'bg-blue-50 border-blue-200', 'textColor' => 'text-blue-700', 'description' => "What was Ian's favourite school dinner?", 'pdf' => 'School dinners.pdf', 'audio' => \App\Helpers\BitstreamHelper::rewriteBitstreamUrl('https://digitalpreservation.is.ed.ac.uk/bitstream/handle/20.500.12734/57057/School%20dinners_EL21-1-1-1.mp3')],
                ['title' => 'Travel and Transport', 'color' => 'green', 'bgColor' => 'bg-green-50 border-green-200', 'textColor' => 'text-green-700', 'description' => 'Listen to Grace talking about meeting the first man to land on the moon.', 'pdf' => 'Travel and Transport.pdf', 'audio' => \App\Helpers\BitstreamHelper::rewriteBitstreamUrl('https://digitalpreservation.is.ed.ac.uk/bitstream/handle/20.500.12734/57057/Travel%20and%20Transport_DG17-1-1-1.mp3')],
                ['title' => 'Sweets', 'color' => 'fuchsia', 'bgColor' => 'bg-fuchsia-50 border-fuchsia-200', 'textColor' => 'text-fuchsia-700', 'description' => 'Listen to Betty and Suzanne Watson chatting about their memories of sweet shops.', 'pdf' => 'Sweets.pdf', 'audio' => \App\Helpers\BitstreamHelper::rewriteBitstreamUrl('https://digitalpreservation.is.ed.ac.uk/bitstream/handle/20.500.12734/57057/Sweets_EL20-2-1-1.mp3')],
                ['title' => 'Toys', 'color' => 'teal', 'bgColor' => 'bg-teal-50 border-teal-200', 'textColor' => 'text-teal-700', 'description' => 'Find out which star wars character came to visit Cyril and Dorothy Wise.', 'pdf' => 'Toys.pdf', 'audio' => \App\Helpers\BitstreamHelper::rewriteBitstreamUrl('https://digitalpreservation.is.ed.ac.uk/bitstream/handle/20.500.12734/57057/Toys_DG14-8-1-1.mp3')],
                ['title' => 'Shopping', 'color' => 'lime', 'bgColor' => 'bg-lime-50 border-lime-200', 'textColor' => 'text-lime-700', 'description' => 'Marion Sunderland talks about shopping. See how much shopping habits have changed.', 'pdf' => 'Shopping.pdf', 'audio' => \App\Helpers\BitstreamHelper::rewriteBitstreamUrl('https://digitalpreservation.is.ed.ac.uk/bitstream/handle/20.500.12734/57057/shopping_DG4-19-1-1.mp3')],
                ['title' => 'Playground Games', 'color' => 'cyan', 'bgColor' => 'bg-cyan-50 border-cyan-200', 'textColor' => 'text-cyan-700', 'description' => 'Listen to Sophie and Derry, aged 8, talking about their favourite playground games.', 'pdf' => 'Playground Games.pdf', 'audio' => \App\Helpers\BitstreamHelper::rewriteBitstreamUrl('https://digitalpreservation.is.ed.ac.uk/bitstream/handle/20.500.12734/57057/Playground%20games_DG31-3-1-1.mp3')],
            ];
        @endphp
