    ...
    <div class="mt-8 space-y-4">
        ...
        <div class="flex flex-col gap-4 rounded-lg border {{ $activity['bgColor'] }} p-4 sm:flex-row sm:items-center">
            ...
            <div class="flex items-center gap-4 sm:w-2/3">
                <a href="{{ '/collections/eerc/images/kids_only_pdfs/' . rawurlencode($activity['pdf']) }}" target="_blank" rel="noopener" class="inline-flex shrink-0 items-center gap-2 rounded-md bg-white px-3 py-2 text-sm font-medium text-gray-700 shadow-sm ring-1 ring-gray-300 hover:bg-gray-50">
