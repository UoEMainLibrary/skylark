...
<div class="lg:grid lg:grid-cols-4 lg:gap-8">
    <div class="lg:col-span-3">
        ...
        <div class="mt-6 prose prose-lg max-w-none">
            ...
            {{-- Scotland map floated right beside opening paragraphs;
            ...
            <div class="not-prose float-right ml-6 mb-4 hidden w-56 sm:block lg:w-72">
                <img src="{{ ($cmsEnabled && $cms?->image_1_path) ? $cms->image1Url() : asset('collections/eerc/images/v2/project-history-scotland-map.png') }}"
                     alt="{{ ($cmsEnabled && $cms?->image_1_path) ? $cms->image_1_alt : 'Interactive map of Scotland showing interview locations' }}"
