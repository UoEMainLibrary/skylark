...
@section('title', 'Feedback - Evergreen - Geddes Project')

@section('content')
<div class="geddes-content feedback_form">
    <h1>Feedback</h1>
    <p>For suggestions or questions relating specifically to this website please contact: <a href="mailto:lddt@mlist.is.ed.ac.uk">lddt@mlist.is.ed.ac.uk</a>.</p>
    ...
    <p>
        If you have any questions, please contact: <a href="mailto:lddt@mlist.is.ed.ac.uk">lddt@mlist.is.ed.ac.uk</a>
    </p>
