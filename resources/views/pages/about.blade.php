...
@section('title', 'About - University of Edinburgh Collections')
...
<div class="container">
    <div class="content byEditor">
        ...
        <p>
            Further information about the <a href="http://www.ed.ac.uk/is/crc" title="Centre for Research Collections" target="_blank">Centre for Research Collections <span class="sr-only">(opens in a new tab)</span></a>.
        </p>
        <h2>Contact</h2>
        <p>
