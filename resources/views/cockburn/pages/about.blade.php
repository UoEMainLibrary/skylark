...
@section('title', 'Geology- Cockburn Collection- About')

@section('content')
<div class="content byEditor">
    <h1>Holding text to be revisited for launch</h1>
    <h2>History of the Cockburn Geological Museum </h2>
    <p>
    ...
    <h2>Cockburn Geological Museum Online</h2>
    <p>
        Info about the site
    </p>
    <h2>University Collections</h2>
    <p>
        Info about the University collections and link to collections.ed.ac.uk
    </p>

    <h2>Contact Details</h2>
    <p>
        For further information about the Cockburn Geological Museum please contact:
    </p>
    <p> Grant Institute of Earth Sciences,<br />
        The University of Edinburgh,<br />
        King's Buildings,<br />
        West Mains Road,<br />
        Edinburgh,<br />
        EH9 3JW<br />
        Phone: +44 (0)131 650 8536<br />
        Fax: +44 (0)131 668 3184<br />
        <a class="email" href="mailto:cockburnmuseum@ed.ac.uk">cockburnmuseum@ed.ac.uk</a><br />
    </p>
