...
@section('title', 'Takedown Policy - Musical Instrument Museums Edinburgh')
    ...
    <div class="content">
        <div class="content byEditor">
            ...
            <p>Centre for Research Collections (Library & University Collections)<br/>
                ...
                Email: <a class="email" href="mailto:HeritageCollections@ed.ac.uk">HeritageCollections@ed.ac.uk</a></p>
            ...
            <ul>
                <li>Describe the infringement in as much detail as possible so that the specific content may be readily
                    identified. The URL in the address bar will allow us to lookup the specific section.</li>
