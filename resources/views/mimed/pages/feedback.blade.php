...
@section('title', 'Feedback - Musical Instrument Museums Edinburgh')
...
<div class="col-main">
    <div class="feedback_form">
        ...
        <p>
            If you have any questions, please contact: <a class="para-link" href="mailto:{{ config('skylight.adminemail') }}">{{ config('skylight.adminemail') }}</a>
        </p>
