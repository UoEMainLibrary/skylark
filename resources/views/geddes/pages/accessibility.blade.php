...
@section('title', 'Accessibility Statement - The Patrick Geddes Archives')
...
<ul>
    ...
    <li>the image carousel on the homepage does not have control buttons to pause or stop or click to &lsquo;previous&rsquo; or &lsquo;next&rsquo; images.</li>
</ul>
...
<p>British Sign Language service Contact Scotland BSL runs a service for British Sign Language users and all of Scotland&rsquo;s public bodies using video relay. This enables sign language users to contact public bodies and vice versa. The service operates 24 hours a day, 7 days a week.</p>
...
<ul>
    ...
    <li>Some content is not read sequentially by screen readers
        <ul>
            <li><a href="https://www.w3.org/TR/WCAG21/#meaningful-sequence">1.3.2 &ndash; Meaningful Sequence</a></li>
        </ul>
    </li>
    ...
    <li>Information, structure and relationships conveyed through presentation cannot always be programmatically determined. This includes missing heading labels
        <ul>
            <li><a href="https://www.w3.org/TR/WCAG21/#headings-and-labels">2.4.6 &ndash; Headings and Labels</a></li>
        </ul>
    </li>
    <li>Visual information to identify user interface components, such as keyboard focus, do not always have a sufficient contrast ratio
        <ul>
            <li><a href="https://www.w3.org/TR/WCAG21/#focus-visible">2.4.7 &ndash; Focus Visible</a></li>
        </ul>
    </li>
...
<p>This website was first tested on 7th August 2020, reviewed on 15th September 2021 and then again on 12th September 2022. The testing was initially carried out by The University of Edinburgh Library and University Collections Digital Library Development team using the automated <a href="https://wave.webaim.org/">Wave WEBAIM</a> and <a href="https://littleforest.co.uk/">Little Forest</a> testing tools, alongside manual testing. The site was tested on a PC, using Mozilla Firefox (91.7.1esr), Microsoft Edge (99.0.1150.55), Google Chrome (99.0.4844.84), and Internet Explorer (IE) (19043.1586) browsers for comparative purposes. We test on Firefox, Chrome and Edge to ensure breadth and variety.</p>
