...
@section('title', 'Accessibility - Public Art')
...
<div class="accessibility">
    <div class="container">
        ...
        <ul>
            ...
            <li>there is no &lsquo;skip to main content&rsquo; function.</li>
        </ul>
        ...
        <ul>
            <li>Not all non-text content presented to users has alternative text
                <ul><li><a href="https://www.w3.org/TR/WCAG21/#non-text-content">1.1.1 - Non-text Content</a></li></ul>
            </li>
            <li>Not all video holds captions, subtitles that identify all speakers, or note other significant sounds (e.g. laughter)
                <ul><li><a href="https://www.w3.org/TR/WCAG21/#captions-prerecorded">1.2.2 - Captions (Prerecorded)</a></li></ul>
            </li>
            ...
            <li>Content will only display in a single page orientation
                <ul><li><a href="https://www.w3.org/TR/WCAG21/#orientation">1.3.4 - Orientation</a></li></ul>
            </li>
            <li>Colour is used as the only visual means of conveying information, indicating an action, prompting a response, or distinguishing a visual element
                <ul><li><a href="https://www.w3.org/TR/WCAG21/#use-of-colour">1.4.1 - Use of Color</a></li></ul>
            </li>
            <li>There may not be sufficient colour contrast between font and background colours, especially where the text size is small
                <ul><li><a href="https://www.w3.org/TR/WCAG21/#contrast-minimum">1.4.3 - Contrast (Minimum)</a></li></ul>
            </li>
            <li>Text cannot be resized without assistive technology up to 200 percent without loss of content or functionality
                <ul><li><a href="https://www.w3.org/TR/WCAG21/#resize-text">1.4.4. Resize Text</a></li></ul>
            </li>
            <li>Information is conveyed as an image of text rather than as text itself, making it not compatible with screen readers and other assistive technology and is not fully customisable
                <ul><li><a href="https://www.w3.org/TR/WCAG21/#images-of-text">1.4.5 - Images of text</a></li></ul>
            </li>
            <li>Site is not fully compatible with browser customisation meaning that users do not have full control and functionality when customising the site (WCAG 2.1 AAA)
                <ul><li><a href="https://www.w3.org/TR/WCAG21/#visual-presentation">1.4.8 - Visual Presentation (AAA)</a></li></ul>
            </li>
            <li>Content cannot be presented without loss of information or functionality, requiring the user to scroll in two dimensions
                <ul><li><a href="https://www.w3.org/TR/WCAG21/#reflow">1.4.10 - Reflow</a></li></ul>
            </li>
            <li>It is not possible to use a keyboard to access all the content
                <ul><li><a href="https://www.w3.org/TR/WCAG21/#keyboard">2.1.1 - Keyboard</a></li></ul>
            </li>
            <li>Users are not always able to pause, stop or hide moving items that appear at some points on the webpage
                <ul><li><a href="https://www.w3.org/TR/WCAG21/#pause-stop-hide">2.2.2 - Pause, Stop, Hide</a></li></ul>
            </li>
            <li>It is not always possible to bypass blocks of content that are repeated on multiple Web pages
                <ul><li><a href="https://www.w3.org/TR/WCAG21/#bypass-blocks">2.4.1 Bypass Blocks</a></li></ul>
            </li>
            <li>Some of our page titles do not fully describe the page content whereas others are missing altogether
                <ul><li><a href="https://www.w3.org/TR/WCAG21/#page-titled">2.4.2 - Page Titled</a></li></ul>
            </li>
            <li>Link purpose is not always clear and some adjacent links go to the same location
                <ul><li><a href="https://www.w3.org/TR/WCAG21/#link-purpose-in-context">2.4.4 - Link Purpose (In Context)</a></li></ul>
            </li>
            <li>Information, structure and relationships conveyed through presentation cannot always be programmatically determined. This includes missing heading labels
                <ul><li><a href="https://www.w3.org/TR/WCAG21/#headings-and-labels">2.4.6 &ndash; Headings and Labels</a></li></ul>
            </li>
            <li>Visual information to identify user interface components, such as keyboard focus, do not always have a sufficient contrast ratio
                <ul><li><a href="https://www.w3.org/TR/WCAG21/#focus-visible">2.4.7 &ndash; Focus Visible</a></li></ul>
            </li>
            <li>Some links open in a new browser window without warning
                <ul><li><a href="https://www.w3.org/TR/WCAG21/#on-input">3.2.2 - On Input</a></li></ul>
            </li>
            <li>The search bar is missing a corresponding form label
                <ul><li><a href="https://www.w3.org/TR/WCAG21/#labels-or-instructions">3.3.2 Labels or Instructions (Level A)</a></li></ul>
            </li>
            <li>The website is not fully compatible with screen readers and voice recognition software
                <ul><li><a href="https://www.w3.org/TR/WCAG21/#parsing">4.1.1 Parsing</a></li></ul>
            </li>
            <li>Screen readers are not able to identify some parts of the page
                <ul><li><a href="https://www.w3.org/TR/WCAG21/#name-role-valuet">4.1.2 - Name, Role, Value</a></li></ul>
            </li>
        </ul>
        ...
        <p>&ldquo;These Regulations do not apply to the following content of a website or mobile application of a public sector body&mdash;
            (d)online maps and mapping services, as long as essential information is provided in an accessible digital manner for maps intended for navigational use;&rdquo; (The Public Sector Bodies (Websites and Mobile Applications) (No. 2) Accessibility Regulations 2018)&rdquo;
        </p>
