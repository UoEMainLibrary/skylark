...
@section('title', 'Paolozzi Mosaic Project - Public Art')

@section('content')
<script src="{{ asset('collections/public-art/js/openseadragon.min.js') }}"></script>
<div id='openseadragon' class='openseadragon' style="width: auto; height: 700px;"></div>
<script>
    var viewer = OpenSeadragon({
        id: "openseadragon",
        prefixUrl: "{{ asset('collections/public-art/images') }}/",
        sequenceMode: true,
...
<section class="info col-xs-12 full-height-section">
    <div class="col-xs-12 col-md-6">
        ...
        <div class="info-mosaic">
            ...
            Consultations includes a number of handling sessions and a dedicated symposium in February 2017 organised by the University as well as talks as part of national and international events including Vandalism and Art Conference in June 2017 and British Association for Modern Mosaics (BAMM) Annual Forum in September 2017. At each event attendees were invited to discuss the project and make suggestions for use of the fragments. As well as forming part of the external, public consultancy around the project this also enables a sense of ownership in the wider community for a public artwork that had come from London. Integration in teaching played a key part in the University being gifted the arches. Since their arrival in Edinburgh students have been involved at every stage of the project. Specifically, the mosaics have been integrated into the Edinburgh Collections undergraduate course.</p>

            <h4>Next Stages</h4>
            <p>Following ten months of research, consultation and reflection, two points of consensus were reached. It was agreed that, firstly, the mosaics should be redisplayed as a public artwork and secondly they should not be remade in their entirety. Their original context in the public realm and the story of what had happened to them was a key part of their identity.</p>
            <p>As well as these conclusions, two options were identified for their future form and use. Firstly, the fragments could be redisplayed in the form of the archway or as part of an entrance. In this way, the link to the functional, historical intention of the original artwork would be retained. Consistently the suggestion of achieving this by creating &lsquo;a ghost arch&rsquo; was suggested. The arches would be redrawn and the fragments would be placed in their location. Areas of loss would be visible and outlined with the redrawn design to allow reference to the complete artwork. This would allow for a sympathetic and conservation based approach to the fragments redisplay.</p>

            <h4>A Ghost Arch?</h4>
            <p>However, as well as losing more than half of the arches, there were other losses to consider. Many who knew and worked with Paolozzi closely felt that creating a ghost arch would be inappropriate and would overlook the spirit of his work. At its core his artworks explored what he referred to as &lsquo;the metamorphosis of rubbish&rsquo; and played with ideas of recycling, reconfiguration, accumulation, and collage of material. The opportunity to engage with these ideas seemed ripe with the mosaic fragments. Moreover, it also was important to remember that the artwork had never been located in Edinburgh. The recreation of a work that had never existed in the city could risk becoming a tragic monument that failed to celebrate the artist or the artwork but only focused on the story of the artwork's removal from the London tube station and subsequent loss. In order to both celebrate Paolozzi, his work and tell the arches' story the fragments could be recreated into something new. A competition process would be organised to obtain artists' proposals for a new work. This new work could then be displayed on campus as part of the art collection. This second option allowed for a contemporary yet loyal solution given the level of damage, the loss of original context and relocation to Edinburgh.</p>

            <h4>The Future</h4>
            <p>Agreeing that the material and contextual loss were too great, the art collection team favoured the idea of using the material for the creation of something new. Following this decision, the art collection team met with the Paolozzi Foundation in October 2017 to update the trustees and seek their support. At this meeting plans for a new chapter of the mosaics history was fully agreed upon and a competition for artists' proposals is currently being developed.</p>
        </div>
    </div>

    <div class="col-xs-12 col-md-6">
        <h3>Media</h3>
        <h4>Information video</h4>
        <p>
            <iframe src="https://player.vimeo.com/video/170003917" width="600" height="450" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
        </p>
    </div>
</section>
@endsection
