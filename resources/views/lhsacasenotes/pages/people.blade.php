...
@section('title', 'People - Lothian Health Service Archives: Medical Case Notes')

@section('content')
<div class="col-md-9 col-sm-9 col-xs-12">
    <div class="content byEditor">
        <h1 class="itemtitle">Norman Dott</h1>
        <img src="{{ asset('collections/lhsacasenotes/images/LHB1CC24-PR1-1536d.gif') }}" alt="Royal Infirmary of Edinburgh" class="img-responsive pull-right img-circle" />
        ...
        <p>Dott was born in Edinburgh in 1897 to art dealer Peter McOmish Dott and his wife, Rebecca, and was the
            ...
            the local engineering firm of McTaggart Scott &amp; Co after he left George Heriot&rsquo;s School. However, a
        ...
        <p>Following Edinburgh-based surgical appointments, teaching and research, Dott was awarded a Rockefeller
            ...
            of Edinburgh. The next stage in Dott&rsquo;s career saw him become Honorary Surgeon at the Royal Edinburgh Hospital for Sick
            Children whilst at the same time working in private practice as a neurosurgeon. Dott used a nursing home in
            Edinburgh&rsquo;s New Town for neurosurgery on private patients, to which he and his team had to transport their
            instruments by taxi or private car!</p>

        <img src="{{ asset('collections/lhsacasenotes/images/LHB1CC24-PR1-1717d.gif') }}" alt="Royal Infirmary of Edinburgh" class="img-responsive pull-left gap-right img-rounded" />

        <p>Dott worked throughout his life for neurosurgery to be recognised and funded as a medical specialism in
            Scotland. Finally, 1938 saw the first patients enter Scotland&rsquo;s first dedicated neurosurgical ward, the Department
