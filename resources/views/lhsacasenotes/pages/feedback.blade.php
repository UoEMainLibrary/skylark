...
@section('title', 'Feedback - Lothian Health Service Archives: Medical Case Notes')

@section('content')
<div class="col-md-9 col-sm-9 col-xs-12">
    <div class="feedback_form">
        <h1 class="itemtitle">Feedback</h1>

        <p>Please contact us with your suggestions or questions at <a class="para-link" href="mailto:lddt@mlist.is.ed.ac.uk">lddt@mlist.is.ed.ac.uk</a>.</p>
        ...
        <p><a class="para-link" href="https://www.ed.ac.uk/about/website/privacy" target="_blank" rel="noopener">University privacy statement</a></p>
    </div>
</div>
