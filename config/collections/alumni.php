...
*/
    ...
    // Map of Collection facet values → per-collection static-page slugs. On the
    // record page the Collection metadata cell renders as
    // "<value>: See All Records | More Info" using the slug's URL.
    'static_pages' => [
        'Students of Medicine, 1762-1826' => 'rosner',
        'First Matriculations, 1890-1899' => 'firstmat',
        'Students at New College, 1843-1943' => 'newcoll',
        'Extra Academical students, 1887-1922' => 'extraac',
        'Graduates in Veterinary Medicine, 1911-1955' => 'vetgrad',
